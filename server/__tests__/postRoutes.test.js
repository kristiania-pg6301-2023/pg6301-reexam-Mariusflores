...
import postRouter from '../routes/postRoutes.js'; // Adjust path if needed
...
describe('Post routes', () => {
  ...
  describe('POST /publish', () => {
    ...
    it('should return 400 if content exceeds limit', async () => {
      ...
      const response = await request(app).post('/publish').send({ content: overLimitString });
    ...
    it('should return 201 if post created successfully', async () => {
      ...
      const response = await request(app).post('/publish').send({ content: content });
  ...
  describe('GET /all', () => {
    it('should return 200 and a list of posts', async () => {
      const mockPosts = [
        { postId: '123', content: 'Hello World', reactions: [] },
        { postId: '321', content: 'Not Hello World', reactions: [] },
      ];
  ...
  describe('GET /user/posts/:userid?', () => {
    ...
    it("should return 200 and a list of logged in user's posts", async () => {
      ...
      const mockPosts = [
        { userid: 'user1', content: 'my first post' },
        { userid: 'user1', content: 'my second post' },
        { userid: 'user1', content: 'my last post' },
      ];
    ...
    it('should return 200 and a list of posts from another user', async () => {
      ...
      const mockPosts = [
        { userid: 'user2', content: 'my first post' },
        { userid: 'user2', content: 'my second post' },
        { userid: 'user2', content: 'my last post' },
      ];
